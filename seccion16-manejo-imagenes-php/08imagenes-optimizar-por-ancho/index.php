...
if ($dir) {
	...
	while ($foto=readdir($dir)) {
		if ($foto != "." && $foto != ".." && validaFoto($foto)) {
			...
			print "</td>";
			print "<td>";
			print "<a href='borrar-foto.php?foto=".$foto."'>Borrar</a>";
			print "</td>";
			print "<td>";
			print "<a href='opciones-foto.php?foto=".$foto."'>Opciones</a>";
			print "</td>";
			print "<td>";
			print "<a href='optimizar-ancho.php?foto=".$foto."'>Opciones Ancho</a>";
			print "</td>";
		}
	}
	print "</tr>";
